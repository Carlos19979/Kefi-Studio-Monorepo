 ...
 */
export const BACKEND_URL = process.env.BACKEND_PUBLIC_URL ?? process.env.RAILWAY_PUBLIC_DOMAIN ?? process.env.RAILWAY_PUBLIC_DOMAIN_VALUE ?? 'http://localhost:9000'
 ...
 * Database URL for Postgres instance used by the backend
 */
export const DATABASE_URL = process.env.DATABASE_URL || "postgres://localhost:5432/medusa-placeholder"
 ...
 */
export const JWT_SECRET = process.env.JWT_SECRET || "supersecret_build_key"

/**
 * Cookie secret used for signing cookies
 */
export const COOKIE_SECRET = process.env.COOKIE_SECRET || "supersecret_build_key"
